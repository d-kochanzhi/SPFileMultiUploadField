...
Assembly="Microsoft.SharePoint, Version=16.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Control Language="C#" AutoEventWireup="true" Inherits="FileMultiUploadField.FileMultiUploadFieldEditControl" %>
...
<wssuc:InputFormControl runat="server" LabelText="Библиотека документов для хранения">
<Template_Control>
